...
@click.command()
@click.option('--t_min', default=1.5, help='Minimum Temperature (inclusive)', type=float)
@click.option('--t_max', default=3, help='Maximum Temperature (inclusive)', type=float)
@click.option('--t_step', default=0.05, help='Temperature Step Size', type=float)
...
@click.option('--n', default=60, help='Lattice Size (NxN)',type=int)
...
@click.option('--num_burnin', default=3000, help='Total Number of Burnin Steps',type=int)
